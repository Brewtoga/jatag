      ...
      <div className="container-reservation">
        ...
        <div className="bullet-container">
          <ul>
            ...
            <li>
              Dinner and Brunch reservations are highly recommended! Come early
              or late for the best chance to snag a walk-in table.{" "}
            </li>
            <li>
              For lunch, we only take reservations for parties of 5 or more.
              Table turnover is fairly quick; we’ll do our best to get you in
              and out!
            </li>
          ...
          <ul>
            ...
            <li>
              ...
              Richmond, Virginia, using the <strong>Resy</strong> app - click
              the button below. We do not use OpenTable.
            </li>
            <li>
              Making a reservation for a special event? Call in advance about
              ordering a homemade pie or cake for your celebration;{" "}
              <strong>
                Parties bringing in outside desserts will be charged a $15
                plating fee.
              </strong>
            </li>
            <li>
